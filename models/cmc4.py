...
class Cmc4Model:
    ...
    def create_model(self):
        ...
        #scontext = CuDNNGRU(self.recdims)(senc)
        ...
        #tosscontext = concatenate([scontext, decout])
        #tossout = TimeDistributed(Dense(self.tdddims, activation="relu"))(tosscontext)
        #tossout = Flatten()(tossout)
        #out2 = Dense(self.comvocabsize, activation="softmax")(tossout)
